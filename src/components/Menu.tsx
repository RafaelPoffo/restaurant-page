...
const Menu = () => {
    ...
    return (
        <div> 
            ...
            {open && ( <div className="bg-red-500 text-white absolute left-0 top-24 h-[calc(100vh-6rem)] w-full flex flex-col gap-8 items-center z-10 justify-center text-3xl">
                {links.map(item=>(
